...
#if REVISION >= 0xA
#define PCSWITCH_ALL_PERIOD                                             180
#define PCSWITCH_SP_PERIOD                                               65
#else
#define PCSWITCH_ALL_PERIOD                                             180
#define PCSWITCH_SP_PERIOD                                               40
#endif
...
#if REVISION >= 0xA
    u16 connect_period_initial;                     // Initial connect period backup for Sloop
#endif
